...
def ecosystem_modeling(river_length_model=10, iterations_model=5, periods=3):
    ...
    # xpoints3 = np.array([x for x in range(1, periods+1)])
    # ypoints3 = np.array(otters_num)
